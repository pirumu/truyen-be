        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-create" action="{{route('the-loai.update',$theLoai->ma_the_loai)}}" method="post">
                        @csrf
                        @method('put')
                        <div class="form-group">
                            <label for="formGroupExampleInput">Tên thể loại</label>
                            <input type="text" class="form-control" name="ten_the_loai" value="{{$theLoai->ten_the_loai}}">
                        </div>
