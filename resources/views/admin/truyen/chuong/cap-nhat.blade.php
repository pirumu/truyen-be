...
@section('content')
    <div class="d-flex align-items-center mb-3">
        <div>
            ...
            <h1 class="page-header mb-0">Cập nhật chương</h1>
        </div>
    ...
    <div class="card">
        <div class="tab-content p-4">
            <div class="tab-pane fade show active" id="allTab">
                <form action="{{route('chuong.update',$chuong->ma_chuong)}}" method="post">
                    @csrf
                    @method('put')
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{$chuong->ten_chuong}}" name="ten_chuong" type="text" class="form-control" id="ten" >
                            </div>
                        </div>
                        <div class="col-xl-12">
                            <div class="form-group">
                                <label for="product-description">Nội dung</label>
                                <textarea name="noi_dung" class="form-control" id="product-description" rows="30">{{$chuong->noi_dung}}</textarea>
                            </div>
