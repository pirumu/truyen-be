      ...
      yaxis: [
        {
          ...
          label: {
            borderColor: COLOR_INDIGO,
            style: { color: COLOR_WHITE, background: COLOR_INDIGO },
            text: "Support",
          },
        },
        {
      ...
      xaxis: [
        {
          ...
          label: {
            borderColor: COLOR_GRAY_900,
            style: { color: COLOR_WHITE, background: COLOR_GRAY_900 },
            text: "Anno Test",
          },
        },
        {
          ...
          label: {
            ...
            style: { fontSize: "10px", color: "#fff", background: COLOR_TEAL },
            offsetY: -7,
            text: "X-axis range",
          },
        },
      ...
      points: [
        {
          ...
          label: {
            ...
            offsetY: 0,
            style: { color: COLOR_WHITE, background: COLOR_PINK },
